      ...
      >
        ...
        <div className="w-full md:w-1/2 lg:w-[45%] relative h-[300px] md:h-auto shrink-0 bg-gray-900 flex-grow-0 md:flex-grow order-first md:order-last pb-6 md:pb-0 aspect-square md:aspect-auto">
          ...
          {story.video ? (
            <>
              <video
                ref={videoRef} src={story.video} autoPlay loop muted playsInline
      ...
      <div className="max-w-[1400px] xl:max-w-[1150px] 2xl:max-w-[1400px] mx-auto w-full px-[clamp(1rem,4vw,2rem)] -mt-[clamp(2rem,4vw,2.5rem)] relative z-20 flex-grow pb-[clamp(4rem,8vh,6rem)]">
        ...
        >
          ...
          <button
            ...
            className="w-full md:w-auto mt-2 md:mt-0 relative z-10 shrink-0 group bg-[#C08F2D] hover:bg-[#a87d25] text-[#1a0409] px-[clamp(1.25rem,2.5vw,1.75rem)] py-[clamp(0.6rem,1.2vw,0.875rem)] rounded-[clamp(0.5rem,1vw,0.75rem)] font-black text-[clamp(0.75rem,1.1vw,0.95rem)] transition-all duration-300 shadow-md hover:shadow-xl hover:-translate-y-1 flex items-center justify-center gap-[clamp(0.35rem,0.8vw,0.5rem)] cursor-pointer"
          >
            ...
            {allStories.map((story) => {
              return (
                <motion.div
                  ...
                  className="w-[280px] sm:w-[320px] md:w-full shrink-0 snap-center break-inside-avoid group bg-white rounded-[clamp(1rem,3vw,2rem)] overflow-hidden border border-gray-100 shadow-sm hover:shadow-2xl transition-all duration-500 cursor-pointer relative flex flex-col focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C08F2D] focus-visible:ring-offset-2"
                >
