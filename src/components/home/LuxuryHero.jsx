      ...
      >
        ...
        <motion.div variants={itemVariants}>
          ...
          <button 
            ...
            className="group relative flex items-center gap-4 bg-transparent border-2 border-[#C08F2D] text-white px-8 py-3.5 rounded-full font-bold text-base overflow-hidden transition-all hover:scale-105 cursor-pointer"
          >
            ...
            <div className="relative z-10 w-8 h-8 border border-white/30 rounded-full flex items-center justify-center group-hover:border-gray-900/30 transition-colors duration-300">
              <ArrowLeft className="w-4 h-4 rtl:-scale-x-100 group-hover:text-gray-900" />
            </div>
          </button>
        </motion.div>
