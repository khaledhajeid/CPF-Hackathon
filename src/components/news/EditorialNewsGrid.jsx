    ...
    <div className="bg-[#fcfcfc] py-24 border-b border-gray-100 overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8">
        ...
        >
          ...
          {/* ❗️ changed from popLayout -> sync (أهدى بكثير) */}
          <AnimatePresence mode="sync">

            {visibleNews.map((item, idx) => {

              const isFeatured =
                idx === 0 && activeFilter === 'الكل';
        ...
        {filteredNews.length > visibleCount && (
          ...
          >
            ...
            <button
              ...
              className="bg-white border-2 border-gray-100 hover:border-[#8a1538] text-[#1a1c1d] hover:text-[#8a1538] hover:shadow-xl px-10 py-4 rounded-full font-black text-sm transition-all duration-300 cursor-pointer flex items-center gap-3 group"
            >
