...
const nationalProgramsData = [
  ...
  { id: 2, title: 'مركز التميز للريادة والابتكار', pathway: 'المشاركة الاقتصادية', description: 'حاضنة للابتكار تهدف إلى دعم الأفكار الريادية للشباب وتحويلها إلى مشاريع ناجحة ومستدامة.', image: 'https://images.unsplash.com/photo-1556761175-5973dc0f32b7?q=80&w=1932', icon: Lightbulb, color: 'from-[#721F31] to-[#3b1019]' },
  ...
  { id: 12, title: 'نَحْنُ', pathway: 'التنمية المجتمعية', description: 'المنصة الوطنية لتطوع ومشاركة الشباب، تهدف لتوحيد جهود العمل التطوعي وتوثيقها بشكل رسمي.', image: 'https://images.unsplash.com/photo-1593113580332-ceb4b62dbba4?q=80&w=2070', icon: Users, color: 'from-[#1f5412] to-[#12330a]' },
