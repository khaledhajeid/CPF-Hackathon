...
import { ArrowUpLeft, Briefcase, Target, Users, Code2, HeartHandshake, Lightbulb, GraduationCap, Globe, Activity, BookOpen } from 'lucide-react';

// 🟢 البرامج المحدثة وإزالة الملغى وتحديث المسارات للأسماء الثلاثة
            ...
            return (
              ...
              >
                <div className="relative w-full h-full transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] rounded-3xl shadow-lg hover:shadow-2xl">
                  ...
                  <div className="absolute inset-0 [backface-visibility:hidden] [transform:rotateY(180deg)] bg-gradient-to-br from-[#8a1538] via-[#521623] to-[#3b1019] rounded-3xl p-8 flex flex-col justify-between border border-[#C08F2D]/30 shadow-inner">
