  ...
  return (
    <div className="py-12 md:py-20 bg-[#fcfcfc] relative border-t border-gray-100 mt-12">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        {programStories.length > 0 ? (
          <div className="flex flex-row overflow-x-auto snap-x snap-mandatory gap-4 md:gap-6 pb-8 scrollbar-hide -mx-4 px-4 md:mx-0 md:px-0 md:grid md:grid-cols-2 lg:grid-cols-3">
