...
export default function HomePage({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-30 -mt-8 lg:-mt-8 xl:-mt-10 mx-4 sm:mx-8 lg:mx-auto max-w-6xl">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          ...
          className="bg-white rounded-xl lg:rounded-xl xl:rounded-2xl shadow-lg p-6 lg:p-6 xl:p-8 border border-gray-50"
        >
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-8 lg:gap-y-0 divide-x divide-x-reverse divide-gray-100 lg:divide-x lg:divide-x-reverse">
            <div className="text-center flex flex-col justify-center">
              <h3 className="text-3xl lg:text-[clamp(1.75rem,3vw,2.25rem)] font-black text-[#8a1538] mb-1 lg:mb-1.5 xl:mb-2">
      ...
      <RevealOnScroll>
        <div className="bg-[#721F31] pt-16 pb-20 lg:pt-16 lg:pb-20 xl:pt-20 xl:pb-24 relative overflow-hidden">
          <div
          ...
          <div className="max-w-4xl mx-auto px-4 md:px-6 relative z-20 text-center flex flex-col items-center">
            <div className="flex items-center justify-center gap-3 md:gap-4 mb-4 md:mb-6">
              <img
                ...
                alt=""
              />
              <h2 className="text-2xl sm:text-3xl lg:text-[clamp(1.5rem,3.5vw,2.25rem)] font-black text-white leading-tight drop-shadow-sm">
                محتار من وين تبدأ <span className="text-[#C08F2D]">مسارك؟</span>
              </h2>
            </div>

            <p className="text-white/90 max-w-xl mx-auto mb-8 md:mb-10 leading-[1.8rem] lg:leading-[1.9rem] xl:leading-[2.2rem] text-sm lg:text-base xl:text-lg font-medium">
            ...
            <button
              ...
              className="bg-[#C08F2D] hover:bg-[#a67b25] text-white px-10 py-4 lg:px-10 lg:py-4 xl:px-14 xl:py-5 rounded-full font-black text-base lg:text-base xl:text-xl transition-all shadow-lg cursor-pointer hover:scale-105"
            >
              ابدأ التوجيه الذكي
            </button>
          </div>
