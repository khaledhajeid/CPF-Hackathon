          ...
          <div className="bg-white rounded-3xl lg:rounded-[2rem] shadow-2xl overflow-hidden border border-gray-100">
            ...
            <div className="p-6 sm:p-8 lg:p-8 2xl:p-12">
              ...
              <form className="space-y-4 lg:space-y-5 2xl:space-y-6">
                ...
                <button type="button" className="w-full bg-[#721F31] hover:bg-[#521623] text-white py-3 lg:py-3.5 2xl:py-4 rounded-lg lg:rounded-xl font-black text-[13px] lg:text-[14px] 2xl:text-base transition-colors flex items-center justify-center gap-2 group mt-4 lg:mt-6">
